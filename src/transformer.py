...
def process_stage_sound_file(input_stage_name: str, output_stage_name: str):
    with SZSTransformerTempDir(os.path.join(GlobalConfig.args.input_romfs_path, f'StageData/{input_stage_name}Sound.szs'), os.path.join(args.output_romfs_path, f'StageData/{output_stage_name}Sound.szs')) as tmpdir:
...
def process_stage_design_file(input_stage_name: str, output_stage_name: str):
    with SZSTransformerTempDir(os.path.join(GlobalConfig.args.input_romfs_path, f'StageData/{input_stage_name}Design.szs'), os.path.join(args.output_romfs_path, f'StageData/{output_stage_name}Design.szs')) as tmpdir:
